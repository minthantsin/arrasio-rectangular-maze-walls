            ...
            for (let i = 0; i < clients.length; ++i) {
                ...
                if (client.player.viewId === playerId) {
                    ...
                    if (playerMuted) {
                        ...
                        util.log('*** ' + socket.player.name + ' muted ' + client.player.name + ' [' + client.ipAddress + '] ***');
                    }
                ...
                if (client.player.viewId === playerId) {
                    ...
                    if (playerInfo) {
                        ...
                        if (now < playerInfo.mutedUntil) {
                            ...
                            util.log('*** ' + socket.player.name + ' unmuted ' + client.player.name + ' [' + client.ipAddress + '] ***');
                        } else {
    ...
    constructor(position, master = this) {
        ...
        this.getAABB = (() => {
            ...
            this.updateAABB = active => {
                ...
                if (sizeDiff > Math.SQRT2 || sizeDiff < Math.SQRT1_2 || sizeVertDiff > Math.SQRT2 || sizeVertDiff < Math.SQRT1_2) {
        ...
        connect: (() => {
                ...
                switch (m.shift()) {
                    ...
                    case 'h':
                        try {
                            ...
                            let truncatedChatMessage = modifiedMessage.length > maxChatMessageLength ? modifiedMessage.substring(0, maxChatMessageLength - 3) + "..." : modifiedMessage.substring(0, maxChatMessageLength);
                                ...
                                if (socket.enableChat === false) {
                                    ...
                                    try {
                                        ...
                                        if (selectedPlayerId > 0) {
                                            sockets.unicastChatMessage(selectedPlayerId, socket, playerName, truncatedChatMessage, truncatedChatMessageFiltered, socket.role);
                                        } else {
                                            sockets.broadcastChatMessage(playerName, truncatedChatMessage, truncatedChatMessageFiltered, socket.role);
                                        }
                                    } catch (error) {
                                        util.error(error);
                                    }
            ...
            const eyes = (() => {
                ...
                function check(camera, obj) {
                    ...
                    if (obj.shape === 200) {
                        // 0.5625 = 9 / 16
                        return Math.abs(obj.x - camera.x) < camera.fov * 0.6 + 1.5 * obj.size + 100 && Math.abs(obj.y - camera.y) < camera.fov * 0.6 * 0.5625 + 1.5 * obj.sizeVert + 100;
                    } else {
                        // 0.5625 = 9 / 16
                            ...
                            let visible = nearby.map(function mapthevisiblerealm(e) {
                                if (e.photo) {
                                    ...
                                    if (e.shape === 200) {
                                        ...
                                        if (Math.abs(e.x - x) < fov / 2 + 1.5 * width && Math.abs(e.y - y) < fov / 2 * (9 / 16) + 1.5 * height) {
                                            // Grab the photo
                    ...
                    let cleanmapreader = (() => {
                        function flattener() {
                            ...
                            function challenge(value, challenger) {
                                ...
                                // Rectangular maze walls.
                                // ============================================================
                                value[4] === challenger[3] && value[5] === challenger[4] && value[6] === challenger[5];
                                // ============================================================
                            }
...
var gameloop = (() => {
    ...
    let collide = (() => {
        ...
        return collision => {
            ...
            // 5 => Tank
            // =============================================================================
            else if (instance.type === 'mazewall' && (other.type === 'tank' || other.type === 'miniboss') || other.type === 'mazewall' && (instance.type === 'tank' || instance.type === 'miniboss')) {
                ...
                // 10 => Food
                // =============================================================================
                else if (instance.type === 'mazewall' && projectileTypeLookup[other.type] || other.type === 'mazewall' && projectileTypeLookup[instance.type]) {
                        if (instance.type === 'mazewall') {
                    ...
                    // 10 => Food
                    // =============================================================================
                    else if (instance.type === 'mazewall' && other.type === 'food' || other.type === 'mazewall' && instance.type === 'food') {
